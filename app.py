...
# ── File Uploader ──────────────────────────────────────────
uploaded_file = st.file_uploader("📂 ارفع الداتا CSV", type="csv")
...
strategy_products = data[
    (data["rating"] >= 4.5) &
    (data["number_of_reviews"] >= 10000) &
    (data["bought_in_last_month"] >= 1000)
].head(20).copy()
...
if page == "analysis":
    ...
    fig7 = go.Figure(data=[go.Table(
        ...
        cells=dict(
            values=[strategy_products["title"].str[:40]],
